...
namespace Innovative.SolarCalculator.Tests
{
    ...
    public class SolarTimesValidationTests
    {
        ...
        {
            DateTimeOffset expected = new DateTimeOffset(2024, 6, 21, 12, 0, 0, TimeSpan.FromHours(2));
            SolarTimes solarTimes = new SolarTimes(expected);
        ...
        {
            DateTimeOffset forDate = new DateTimeOffset(2024, 6, 21, 12, 0, 0, TimeSpan.FromHours(5));
            Angle latitude  = new Angle(28.6139d);
            Angle longitude = new Angle(77.2090d);

            SolarTimes solarTimes = new SolarTimes(forDate, latitude, longitude);
        ...
        {
            DateTime forDate = new DateTime(2024, 6, 21, 12, 0, 0);
            double timeZoneOffset = 5.5;
            double latitude  = 28.6139;
            double longitude = 77.2090;

            SolarTimes solarTimes = new SolarTimes(forDate, timeZoneOffset, latitude, longitude);
        ...
        public void DateTimeWithTimeZoneInfoAndDoubleCoordinatesConstructor_SetsAllProperties()
        {
            ...
            DateTime forDate = new DateTime(2024, 6, 21, 0, 0, 0);
            double latitude  = 52.50;
            double longitude = 13.35;

            SolarTimes solarTimes = new SolarTimes(forDate, berlin, latitude, longitude);
        ...
        public void DateTimeWithTimeZoneInfoAndAngleCoordinatesConstructor_SetsAllProperties()
        {
            var berlin = TimeZoneInfo.FindSystemTimeZoneById("Europe/Berlin");
            DateTime forDate = new DateTime(2024, 6, 21, 0, 0, 0);
            Angle latitude  = new Angle(52.50d);
            Angle longitude = new Angle(13.35d);
        ...
        public void AtmosphericRefraction_IncreasingValue_EarlierSunrise()
        {
            ...
            SolarTimes baseline = new SolarTimes
            {
                Latitude  = -33.856837,
            ...
            SolarTimes higherRefraction = new SolarTimes
            {
                Latitude             = -33.856837,
                Longitude            = 151.215066,
                ForDate              = new DateTimeOffset(new DateTime(2020, 7, 21), TimeSpan.FromHours(10)),
        ...
        {
            SolarTimes withRefraction = new SolarTimes
            {
                Latitude  = -33.856837,
                Longitude = 151.215066,
                ForDate   = new DateTimeOffset(new DateTime(2020, 7, 21), TimeSpan.FromHours(10))
            ...
            SolarTimes noRefraction = new SolarTimes
            {
                Latitude             = -33.856837,
                Longitude            = 151.215066,
                ForDate              = new DateTimeOffset(new DateTime(2020, 7, 21), TimeSpan.FromHours(10)),
